    ...
    return (
        <div className="flex items-center gap-4 ml-auto">
            ...
            {isPro ? (
                ...
                <Link href="/pricing" className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-[#E57A21] px-4 py-1.5 font-medium text-white transition duration-300 ease-out hover:scale-105 active:scale-95">
                    <span className="absolute inset-0 z-0 h-full w-full bg-gradient-to-br from-[#FF9841] via-[#E57A21] to-[#C96716] opacity-100 transition-opacity duration-500 group-hover:opacity-80 border-b-2 border-[#b05810]" />
                    {/* Shimmer effect */}
